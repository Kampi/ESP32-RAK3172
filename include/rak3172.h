 ...
 *                  RAK3172_INVALID_ARG when an invalid argument was passed
 */
RAK3172_Error_t RAK3172_Init_LoRaWAN(RAK3172_t* p_Device, uint8_t TxPwr, uint8_t Retries, RAK3172_JoinMode_t JoinMode, uint8_t* p_Key1, uint8_t* p_Key2, uint8_t* p_Key3, char Class, RAK3172_Band_t Band, RAK3172_SubBand_t Subband, uint32_t Timeout = 10);
 ...
 *  @return         RAK3172_OK when successful
 *                  RAK3172_FAIL when the receive task can´t get started
 *                  RAK3172_INVALID_ARG when an invalid argument is passed into the function
 */
